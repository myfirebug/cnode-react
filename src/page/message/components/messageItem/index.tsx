...
const MessageItem: FC<IMessageItemProps> = ({
  ...
  return (
    <div className="sz-message__item">
      <div
        className="sz-message__item--header"
        onClick={() => history.push(`/my?loginname=${author.loginname}`)}
      >
      ...
      <div
        className="sz-message__item--body"
        dangerouslySetInnerHTML={{ __html: `${reply.content}` }}
      ></div>
      <div
        className="sz-message__item--footer"
        onClick={() => history.push(`/details?id=${topic.id}`)}
      >
        {topic.title}
      </div>
    </div>
